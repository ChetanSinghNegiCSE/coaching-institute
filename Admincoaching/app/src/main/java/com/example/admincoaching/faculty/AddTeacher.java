...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addTeacherCategory.setAdapter(new ArrayAdapter<String>(this
        ...
        uploadTask.addOnCompleteListener(AddTeacher.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if(task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(AddTeacher.this, "Something want wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void insertData() {
        ...
        dbRef.child(uniqueKey).setValue(teacherData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                ...
                /*PushNotification notification = new PushNotification(new NotificationData("Faculty","New Faculty Uploaded", R.id.titleNoti), TOPIC);
   ...
   /* private void sendNotification(PushNotification notification) {
        ApiUtilities.getClient().sendNotification(notification).enqueue(new Callback<PushNotification>() {
            ...
            public void onFailure(Call<PushNotification> call, Throwable t) {
                ...
                Toast.makeText(AddTeacher.this, t.getMessage(), Toast.LENGTH_SHORT).show();
