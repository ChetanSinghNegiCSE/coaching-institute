...
import com.example.admincoaching.faculty.AddTeacher;
import com.example.admincoaching.faculty.TeacherAdepter;
import com.example.admincoaching.faculty.TeacherData;
...
public class UploadAnsKey extends AppCompatActivity {
        ...
        reference.child("Defence").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    adapter = new MagazineAdapter(UploadAnsKey.this, list,"Defence");
                    ebookRecycler1.setLayoutManager(new LinearLayoutManager(UploadAnsKey.this));
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(UploadAnsKey.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        reference.child("JEE").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    adapter = new MagazineAdapter(UploadAnsKey.this, list,"JEE");
                    ebookRecycler2.setLayoutManager(new LinearLayoutManager(UploadAnsKey.this));
        ...
        reference.child("NEET").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    adapter = new MagazineAdapter(UploadAnsKey.this, list,"NEET");
                    ebookRecycler3.setLayoutManager(new LinearLayoutManager(UploadAnsKey.this));
        ...
        reference.child("SSC").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    adapter = new MagazineAdapter(UploadAnsKey.this, list,"SSC");
                    ebookRecycler4.setLayoutManager(new LinearLayoutManager(UploadAnsKey.this));
        ...
        reference.child("Banking").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    adapter = new MagazineAdapter(UploadAnsKey.this, list,"Banking");
                    ebookRecycler5.setLayoutManager(new LinearLayoutManager(UploadAnsKey.this));
        ...
        reference.child("Group C(UK)").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    adapter = new MagazineAdapter(UploadAnsKey.this, list,"Group C(UK)");
                    ebookRecycler6.setLayoutManager(new LinearLayoutManager(UploadAnsKey.this));
        ...
        reference.child("Other Exam").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    adapter = new MagazineAdapter(UploadAnsKey.this, list,"Other Exam");
                    ebookRecycler7.setLayoutManager(new LinearLayoutManager(UploadAnsKey.this));
